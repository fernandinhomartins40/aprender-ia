...
export const metadata: Metadata = {
  ...
  // Gerado pela rota, a partir do banco: o arquivo estático declarava
  // PNG enquanto o painel servia WebP, e o Chrome descartava os ícones.
  manifest: "/manifest.webmanifest",
  appleWebApp: { capable: true, statusBarStyle: "default", title: "Aprender IA" },
  icons: {
    // FAVICON — só a aba do navegador. Vive no repositório e não tem
    // relação com o ícone do aplicativo: trocar um nunca troca o outro.
    icon: [
      { url: "/favicon.ico", sizes: "16x16 32x32 48x48" },
      { url: "/favicon-32.png", type: "image/png", sizes: "32x32" },
      { url: "/favicon-96.png", type: "image/png", sizes: "96x96" },
    ],
    // ÍCONE DO APLICATIVO no iOS. Sem `type` declarado de propósito: o
    // arquivo pode ser WebP (enviado pelo painel) ou PNG (reserva do
    // repositório), e declarar o tipo errado faz o sistema recusar.
    // O iOS escolhe pelo tamanho: iPhone usa 180, iPad 152 ou 167.
    apple: [
